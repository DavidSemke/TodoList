    ...
    function TodoItem(title, descrip=null, dueDate=null) {
        ...
        function setTitle(newTitle) {
            ...
            for (const sibling of siblings) {
                let siblingTitle = sibling.getTitle().toUpperCase()
                let title = newTitle.toUpperCase()
...
const project1 = _logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.TodoItem('project1')
const project2 = _logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.TodoItem('project2')

_logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.addToProjectList(project1)
_logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.addToProjectList(project2)

const child1 = _logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.TodoItem('child1')
const child2 = _logic_js__WEBPACK_IMPORTED_MODULE_1__.todo.TodoItem('child2')
